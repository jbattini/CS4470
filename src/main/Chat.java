...
public class Chat {
	...
	public static void command(String command) {
		...
		case "list":
			...
			break;
		case "terminate": client.speakToServer(args);
			break;
		case "send":
			if (cmd3.length() > 100) {
	...
	public static void help() {
		...
		System.out.println(
				"send <connection id> <message>:  This will send the message to the host on the connection that is designated by the number 3 when command “list” is used. ");
		System.out.println(
				"exit:  Close all connections and terminate this process. The other peers should also update their connection list by removing the peer that exits.");
		System.out.println("==============================================");
		System.out.println();
	}
